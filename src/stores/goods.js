...
export const useGoodsStore = defineStore('goods', () => {
  ...
  const list = ref([
    { id: 1, name: 'Письмо из Хогвартса', price: 490, category: 1 },
    ...
    { id: 6, name: 'Кулон Слизерина', price: 490, category: 2 },
    ...
    { id: 10, name: 'Обложка на паспорт Always', price: 450 },
    ...
    { id: 13, name: 'Шахматы Гарри Поттер', price: 5990 },
    { id: 14, name: 'Игральные карты Гарри Поттер', price: 390 },
    { id: 15, name: '3D светильник Олень', price: 990 }
  ])

  const goodsList = (categoryId) => {
    return categoryId ? list.value.filter((v) => v.category === categoryId) : list.value
  }
